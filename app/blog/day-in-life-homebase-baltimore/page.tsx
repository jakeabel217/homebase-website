        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <header className="mb-12">
            <div className="text-sm text-gray-500 mb-4">
              Published January 25, 2026 • By Sarah Mitchell, Marketing Consultant & HomeBase Member
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              A Day in the Life: Working from HomeBase Baltimore
            </h1>
            <p className="text-xl text-gray-700 leading-relaxed">
              <em>Sarah Mitchell is a marketing consultant and digital strategist who's been a HomeBase member for nearly two years. We asked her to share what a typical workday looks like at HomeBase Baltimore. Here's her story.</em>
            </p>
          </header>
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">7:45 AM – The Commute That Doesn't Suck</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">8:00 AM – Settling In</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">8:30 AM – Deep Work Block</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">11:30 AM – Coffee Break & Unexpected Networking</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">12:00 PM – Client Call in the Conference Room</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">1:00 PM – Lunch Break Done Right</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">2:00 PM – Afternoon Productivity</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">3:30 PM – Community & Collaboration</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">4:30 PM – Last Push</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12">6:00 PM – Shutdown Ritual</h2>
