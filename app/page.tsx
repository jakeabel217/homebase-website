    ...
    <div className="bg-white">
      ...
      <section className="relative h-screen pt-16">
        ...
        <div className="relative h-full flex items-center justify-center text-center px-4">
          <div className="bg-white/95 rounded-xl px-8 py-6 max-w-3xl shadow-xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition border-2 border-[#FF5722] relative">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-[#FF5722] text-white px-6 py-1 rounded-full text-sm font-semibold whitespace-nowrap">
                MOST POPULAR
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2 mt-2">Dedicated Desk</h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm flex items-start gap-4">
              <div className="w-10 h-10 bg-[#FF5722]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg width="20" height="20" className="text-[#FF5722]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="location" className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 mb-4">300 W Pratt Street — steps from Camden Yards and the Inner Harbor</p>
          </div>
